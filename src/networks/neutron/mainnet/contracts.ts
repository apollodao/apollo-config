...
export const contracts: Contract[] = [
  {
    ...
    description:
      "This vault takes in ASTRO/axlUSDC Astroport LP tokens and autocompounds any rewards back into the LP position. There is no lockup period for this vault and funds can be withdrawn at any time.",
    address:
  ...
  },
  {
    ...
    description:
      "This vault takes in wstETH/axlWETH Astroport PCL LP tokens and autocompounds any rewards back into the LP position. Funds are locked for 7 days after withdrawal.",
    address:
  ...
  },
  {
    ...
    description:
      "This vault takes in NTRN/wstETH Astroport PCL LP tokens and autocompounds any rewards back into the LP position. Funds are locked for 7 days after withdrawal.",
    address:
  ...
  {
    label: "nobleUSDC/NTRN Unlocked Vault",
    description:
      "This vault takes in NTRN/USDC Astroport PCL LP tokens and autocompounds any rewards back into the LP position. The vault has a 1% exit fee, that is compounded back into the vault.",
    address:
      "neutron14xx9hcw0cyw2vtxh586h5usymfyk06jnj677awhntrkxtm72amrsmj5fxt",
    admin: "neutron1qnpwxhrgd8mmsfgql7df6kusgjr3wvm4trl05xu260seelwh845qtqqq9t",
    code_id: 766,
  },
];
