...
export const tokens: (Omit<Token, "sources"> & {
  ...
  },
  {
    ...
    asset: {
      native:
        "factory/neutron14xx9hcw0cyw2vtxh586h5usymfyk06jnj677awhntrkxtm72amrsmj5fxt/VaultToken/pcl/0d/nobleUSDC/NTRN",
    },
    base: {
    ...
    sources: [
      {
        ...
        params: {
          dex: "astroport",
          contract_address:
            "neutron1q3rfmflhp79rz0sdjxdgf7t3x5twce9az6n0fegspkjstrax42kq0g96rn",
          underlying_tokens: [
            {
              native:
                "ibc/B559A80D62249C8AA07A380E2A2BEA6E5CA9A6F079C912C3A9E9B494105E4F81",
